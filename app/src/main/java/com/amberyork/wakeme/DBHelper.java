 ...
 * */
    ...
    //get all alarms as string list to display in alarm list fragment
    public ArrayList<String> getAllAlarmStrings() {
        ArrayList<String> data = new ArrayList<String>();
        String selectQuery = "SELECT  datetime(set_time,'YYYY-MM-DD HH:MM:SS FROM') FROM alarm";  //todo parameterize
        ...
        if (c.moveToFirst()) {
            do {
                data.add(c.getString(c.getColumnIndex(COLUMN_ALARM_SET_TIME)));
